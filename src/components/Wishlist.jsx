					...
					<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12'>
						<div className='bg-white shadow-md rounded-lg overflow-hidden'>
							...
							<div className='p-4'>
								...
								<button className='bg-red-500 text-white w-full mt-4 py-2 flex justify-center items-center rounded hover:bg-red-500'>
						...
						<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6'>
							<div className='bg-white shadow-md rounded-lg overflow-hidden'>
								...
								<div className='p-4'>
									...
									<button className='bg-red-500 text-white w-full mt-4 py-2 flex justify-center items-center rounded hover:bg-yellow-600'>
										<MdOutlineShoppingCart className='mr-2' />{" "}
										Add To Cart
									</button>
								</div>
